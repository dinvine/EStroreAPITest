...
namespace SpecflowAPIAutomation.Utilities
{
    public static class Libraries
    {
        ...
        public static string GetNestedResponseObject(this IRestResponse response, string responseObject, string nestedResponseObject)
        {
            JObject obs = JObject.Parse(response.Content);
